...
// If expressions
// We have already seen these in the absolute value example.
// Here's the same example using isize/usize instead of i64/u64.
...
pub fn for_loop() {
    ...
    let v: Vec<&str> = vec!["ecs", "189C", "rust", "programming"];
